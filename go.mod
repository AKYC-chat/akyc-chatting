module github.com/AKYC-chat/akyc-chatting

go 1.21.4

replace github.com/AKYC-chat/akyc-chatting/connector => ./connector

replace github.com/AKYC-chat/akyc-chatting/message => ./message
